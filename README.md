...
* ### [Architect](https://aleenalhussain.github.io/Architect-Project/)
    The Architect Landing Page is a visually appealing designed to showcase an architect's portfolio, services, and contact information. Built using only HTML and CSS, it highlights the essence of clean design and structured layout while offering a user-friendly experience.
* ### [Grocery](https://aleenalhussain.github.io/SEF-Second-Project/)
   The Grocery Store Website is a modern, responsive platform designed to offer users a seamless shopping experience for their daily essentials. It allows users to browse a variety of    products, add items to their cart, and manage orders effortlessly.using only html5 css3
* ### [Travel](https://aleenalhussain.github.io/SEF-ThirdProject/)
    Travel Landing Page Overview The Travel Landing Page is a visually engaging and responsive single-page website designed to inspire users to explore travel destinations and encourage bookings. It serves as a front-facing marketing tool for travel agencies, showcasing destinations, services, and exclusive offers.using Html,Css,Js with animation
